...
class SudokuAPITesT(unittest.TestCase):
    ...
    def test_json_post(self):
        ...
        response = self.client.post('/', data=json_data,
    ...
    def test_invalid_len_in_json(self):
        ...
        response = self.client.post('/', data=json_data,
                                    content_type='application/json')
        self.assert_response(response, 1, [invalid_puzzle], [None],
                             ['error'], ['Input length is 82'])
    ...
    def test_multiple_puzzles_in_json(self):
        ...
        response = self.client.post('/', data=json_data,
                                    content_type='application/json')
        self.assert_response(response, 2,
                             [self.sudoku.puzzle, self.sudoku.puzzle],
    ...
    def test_multiple_invalid_puzzles_in_json(self):
        invalid_puzzle = self.sudoku.puzzle + '.'
        json_data = json.dumps({'sudoku':
                                [self.sudoku.puzzle, invalid_puzzle]})
        response = self.client.post('/', data=json_data,
                                    content_type='application/json')
        self.assert_response(response, 2,
                             [self.sudoku.puzzle, invalid_puzzle],
